...
def main():
    ...
    config = {
        "path-to-dataset": "/beegfs/common/data/climate/bahareh/ICHEC-EC-EARTH_historical_r1i1p1_KNMI-RACMO22E_v1/tas/tasAdjustInterp_HYR-5_ICHEC-EC-EARTH_historical_r1i1p1_KNMI-RACMO22E_v1-DWD-MMBC-v1-HYRAS-v3-0-1951-2005_DWD-PCA-v1_day_19510101-19541231.nc"
    }
    if len(sys.argv) > 1:
